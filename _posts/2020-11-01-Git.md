...
El **ancho de banda absoluto** de una señal es la anchura del espectro o conjunto de frecuencias que la componen (el cual puede ser infinito). Si la mayor parte de la entergía de la señal se concentra en una banda de frecuencias estrecha se la denomina **ancho de banda efectivo** o **ancho de banda**. Es decirm 
